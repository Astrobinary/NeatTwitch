...
class videoplayerlist extends Component {
  constructor(props) {
    ...
    if (this.props.location.state === undefined) {
      ...
      this.state = { back, src: "", video: this.props.location.state.videos[this.props.location.state.current], next: this.props.location.state.videos[this.props.location.state.next], prev: this.props.location.state.videos[this.props.location.state.prev] };
    }
  }
    ...
    return (
      <div>
        <div className="back-to">
          <Link to={`/ok`}>Back to {this.state.back}</Link>
        </div>
        <section className="videoplayer">
          <SimpleStorage parent={this} blacklist={["src", "height", "video", "next", "prev", "back"]} />
